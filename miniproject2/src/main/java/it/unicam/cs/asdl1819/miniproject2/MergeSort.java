...
public class MergeSort<E extends Comparable<E>> implements SortingAlgorithm<E> {
	...
	private SortingAlgorithmResult<E> recSort(List<E> l, int start, int stop) {
		...
		return new SortingAlgorithmResult<E>(l,
				left.getCountCompare() + right.getCountCompare() + merge.getCountCompare());
	}
	 ...
	 */
	private SortingAlgorithmResult<E> merge(List<E> l, int start, int middle, int stop) {
		int countCompare = 0;
