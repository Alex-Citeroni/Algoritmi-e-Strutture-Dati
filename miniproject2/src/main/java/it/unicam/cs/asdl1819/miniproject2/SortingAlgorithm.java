 ...
 *        avere un ordinamento naturale totale fra i suoi elementi realizzato
 *        tramite l'implementazione dell'interfaccia Comparable.
 */
public interface SortingAlgorithm<E extends Comparable<E>> {
	 ...
	 * @return un oggetto contentente la lista ordinata e il numero di operazioni di
	 *         comparazione effettuate dall'algoritmo.
	 */
