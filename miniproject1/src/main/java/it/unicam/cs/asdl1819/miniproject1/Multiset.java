 ...
 * @author Luca Tesei
 *
 * @param <E> the type of the elements of the multiset. If a multiset containing
...
public interface Multiset<E> {
	 ...
	 * 
	 * @return the number of elements in this multiset counting all the occurrences
	 *
	 */
	public int size();
	 ...
	 * @return the number of occurrences of the {@code element} in this multiset;
	 ...
	 *                                  {@code Integer.MAX_VALUE} occurrences of the
	 *                                  element
	 * @throws NullPointerException     if {@code element} is null.
	 */
	 ...
	 * @throws NullPointerException     if {@code element} is null
	 * @throws IllegalArgumentException if {@code Integer.MAX_VALUE} occurrences of
	...
	/**
	 * Returns the set of distinct elements contained in this multiset. The order of
	 * the elements in the element set is unspecified.
	 *
	...
	/**
	 * Returns an iterator for the multiset. The iterator must present all elements
	 * of the multiset and for each element it must present all the occurrences.
	 * Occurrences of the same element must be presented in sequence. The iterator
	 * is not required to implement the remove operation.
	 * 
	...
	/**
	 * Removes all of the elements from this multiset. The multiset will be empty
