...
public class AdjacentListDirectedGraphTest {
	...
	public final void testEdgeCount() {
		...
		g.addNode(nu);
		GraphEdge<String, String> esu = new DefaultGraphEdge<String, String>(ns, nu, "from s to u", true, 10.1);
		g.addEdge(esu);
		...
		g.addNode(nx);
		GraphEdge<String, String> esx = new DefaultGraphEdge<String, String>(ns, nx, "from s to x", true, 5.12);
		g.addEdge(esx);
	...
	public final void testGetPredecessorNodes() {
		...
		GraphEdge<String, String> esx = new DefaultGraphEdge<String, String>(ns, nx, "from s to x", true, 5.12);
		g.addEdge(esx);
		GraphEdge<String, String> eux = new DefaultGraphEdge<String, String>(nu, nx, "from u to x", true, 2.05);
		g.addEdge(eux);
		GraphEdge<String, String> exu = new DefaultGraphEdge<String, String>(nx, nu, "from x to u", true, 3.04);
		g.addEdge(exu);
		assertEquals(true, g.getPredecessorNodes(ns).equals(predNodes));
		GraphNode<String> ny = new DefaultGraphNode<String>("y");
		GraphNode<String> nyTest = new DefaultGraphNode<String>("y");
		g.addNode(ny);
		GraphEdge<String, String> exy = new DefaultGraphEdge<String, String>(nx, ny, "from x to y", true, 2.0);
		g.addEdge(exy);
		GraphEdge<String, String> eys = new DefaultGraphEdge<String, String>(ny, ns, "from y to s", true, 7.03);
		g.addEdge(eys);
	...
	public final void testAddEdgeIllegal2() {
		...
		GraphNode<String> nu = new DefaultGraphNode<String>("u");
		g.addNode(nu);
		GraphEdge<String, String> esu = new DefaultGraphEdge<String, String>(ns, nu, "from s to u", false, 10.1);
		g.addEdge(esu);
	}
	...
	public final void testAddEdge() {
		...
		GraphEdge<String, String> esu = new DefaultGraphEdge<String, String>(ns, nu, "from s to u", true, 10.1);
		g.addEdge(esu);
		GraphEdge<String, String> esuTest = new DefaultGraphEdge<String, String>(ns, nu, "from s to u", true, 10.1);
	...
	public final void testGetEdgesGraphNodeOfV() {
		...
		GraphEdge<String, String> esx = new DefaultGraphEdge<String, String>(ns, nx, "from s to x", true, 5.12);
		g.addEdge(esx);
		GraphEdge<String, String> esxTest = new DefaultGraphEdge<String, String>(ns, nx, "from s to x", true, 5.12);
	...
	public final void testGetIngoingEdges() {
		...
		g.addEdge(esx);
		GraphEdge<String, String> eux = new DefaultGraphEdge<String, String>(nu, nx, "from u to x", true, 2.05);
		GraphEdge<String, String> euxTest = new DefaultGraphEdge<String, String>(nu, nx, "from u to x", true, 2.05);
		g.addEdge(eux);
		GraphEdge<String, String> exu = new DefaultGraphEdge<String, String>(nx, nu, "from x to u", true, 3.04);
		GraphEdge<String, String> exuTest = new DefaultGraphEdge<String, String>(nx, nu, "from x to u", true, 3.04);
		g.addEdge(exu);
		GraphNode<String> ny = new DefaultGraphNode<String>("y");
		g.addNode(ny);
		GraphEdge<String, String> exy = new DefaultGraphEdge<String, String>(nx, ny, "from x to y", true, 2.0);
		GraphEdge<String, String> exyTest = new DefaultGraphEdge<String, String>(nx, ny, "from x to y", true, 2.0);
		g.addEdge(exy);
		GraphEdge<String, String> eys = new DefaultGraphEdge<String, String>(ny, ns, "from y to s", true, 7.03);
		GraphEdge<String, String> eysTest = new DefaultGraphEdge<String, String>(ny, ns, "from y to s", true, 7.03);
		g.addEdge(eys);
	...
	public final void testGetDegree() {
		...
		g.addNode(nv);
		GraphEdge<String, String> euv = new DefaultGraphEdge<String, String>(nu, nv, "from u to v", true, 1.0);
		g.addEdge(euv);
		GraphEdge<String, String> exv = new DefaultGraphEdge<String, String>(nx, nv, "from u to v", true, 9.05);
		g.addEdge(exv);
		GraphEdge<String, String> eyv = new DefaultGraphEdge<String, String>(ny, nv, "from y to v", true, 6.0);
		g.addEdge(eyv);
		GraphEdge<String, String> evy = new DefaultGraphEdge<String, String>(nv, ny, "from v to y", true, 4.07);
		g.addEdge(evy);
	...
	public final void testGetEdgesBetweenGraphNodeOfVGraphNodeOfV() {
		...
		GraphEdge<String, String> esuBis = new DefaultGraphEdge<String, String>(ns, nu, "from s to u", true, 10.1);
		g.addEdge(esuBis);
		assertEquals(true, g.getEdgesBetween(ns, nu).equals(edgesTest));
		GraphEdge<String, String> esuDiversoLabel = new DefaultGraphEdge<String, String>(ns, nu, "pippo", true, 10.1);
		g.addEdge(esuDiversoLabel);
		GraphEdge<String, String> esuDiversoLabelTest = new DefaultGraphEdge<String, String>(ns, nu, "pippo", true,
				10.1);
		edgesTest.add(esuDiversoLabelTest);
		assertEquals(true, g.getEdgesBetween(ns, nu).equals(edgesTest));
		GraphEdge<String, String> esuDiversoLabelNull = new DefaultGraphEdge<String, String>(ns, nu, null, true, 10.1);
		g.addEdge(esuDiversoLabelNull);
		GraphEdge<String, String> esuDiversoLabelNullTest = new DefaultGraphEdge<String, String>(ns, nu, null, true,
				10.1);
		edgesTest.add(esuDiversoLabelNullTest);
		assertEquals(true, g.getEdgesBetween(ns, nu).equals(edgesTest));
		GraphEdge<String, String> esuDiversoPeso = new DefaultGraphEdge<String, String>(ns, nu, "from s to v", true,
				1.1);
		g.addEdge(esuDiversoPeso);
		GraphEdge<String, String> esuDiversoPesoTest = new DefaultGraphEdge<String, String>(ns, nu, "from s to v", true,
				1.1);
